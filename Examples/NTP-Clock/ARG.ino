...
void setup() {
  ...
  //set font to 16 pt
  Heltec.display->setFont(ArialMT_Plain_10);
  if(ssid == "YOUR_SSID_HERE"){
    Heltec.display->drawString(0, 0, "Head to ");
    Heltec.display->drawString(0, 15, "github.com/jamesmatchett/");
    Heltec.display->drawString(0, 30, "/esp32-fun");
  } else{
